...
def extract_tweet_info(tweet):
    ...
    user = tweet[u'user']
    result['user'] = user[u'screen_name'].encode('utf8')
    result['name'] = user[u'name'].encode('utf8')
    result['location'] = user[u'location'].encode('utf8')
    result['text'] = tweet[u'text'].encode('utf8')
    ...
    result['hashtags'] = [hashtag[u'text'].encode('utf8') for hashtag in hashtags]
    result['mentions'] = [um[u'screen_name'].encode('utf8') for um in user_mentions]
    result['urls'] = [url[u'expanded_url'].encode('utf8') for url in urls]
